...
echo "开始安装Caddy"
cd /tmp
wget -q https://raw.githubusercontent.com/Jevanzhu/Caddy-Installer/main/caddy-1.0.5+F
...
echo "配置systemd"
curl -s https://raw.githubusercontent.com/Jevanzhu/Caddy-Installer/main/caddy.service -o /etc/systemd/system/caddy.service
